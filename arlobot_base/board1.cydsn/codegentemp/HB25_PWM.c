...
void HB25_PWM_Enable(void)
{
    ...
    #if (HB25_PWM__QUAD == HB25_PWM_CONFIG)
        #if (0u != HB25_PWM_QUAD_AUTO_START)
            HB25_PWM_TriggerCommand(HB25_PWM_MASK, HB25_PWM_CMD_RELOAD);
        #endif /* (0u != HB25_PWM_QUAD_AUTO_START) */
    #endif  /* (HB25_PWM__QUAD == HB25_PWM_CONFIG) */
}
...
*   Values:
*     - HB25_PWM_CMD_CAPTURE    - Trigger Capture/Switch command
*     - HB25_PWM_CMD_RELOAD     - Trigger Reload/Index command
*     - HB25_PWM_CMD_STOP       - Trigger Stop/Kill command
*     - HB25_PWM_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
